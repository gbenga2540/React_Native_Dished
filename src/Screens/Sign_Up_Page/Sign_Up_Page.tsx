...
import { FIREBASE_USERS_COLLECTION, SECURE_STORAGE_NAME, SECURE_STORAGE_USER_INFO } from '@env';
...
const SignUpPage: FunctionComponent = () => {
                                                ...
                                                await auth()
                                                        ...
                                                        .catch(error => {
                                                                ...
                                                                error_handler({
                                                                        ...
                                                                        error_mssg: 'An error occured while trying to register User!',
        ...
        return (
                <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.signup_main}>
                        ...
                        <ScrollView style={{ flex: 1 }} ref={ref => (scrollViewRef.current = ref)}>
                                ...
                                <View style={styles.s_m_input_cont}>
                                        <Text style={[styles.s_m_input_text, { marginTop: 26 }]}>Email</Text>
                                        <BasicTextEntry inputValue={email} setInputValue={setEmail} placeHolderText="johndoe@gmail.com" keyboardType="email-address" />
                                        <Text style={[styles.s_m_input_text, { marginTop: 20 }]}>Password</Text>
                                        <SecureTextEntry inputValue={password} setInputValue={setPassword} keyboardType="default" />
                                        <BasicButton buttonText="Get Started" buttonHeight={52} marginTop={45} disabled={disableButton} marginBottom={16} execFunc={() => on_get_started()} />
                                        <TextDivider text={'or'} />
                                        <BasicLogoButton logoName="Google" inputText="Sign Up with Google" marginTop={16} disabled={disableButton} execFunc={() => sign_in_with_google()} />
                                        <View style={styles.s_m_acc}>
                                                <Text style={styles.s_m_acc_text}>Already have an account?</Text>
                                                <TextButton
                                                        buttonText="Sign In"
                                                        marginLeft={3}
