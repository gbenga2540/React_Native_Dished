...
const SelectProfilePage: FunctionComponent = () => {
        ...
        const [identityValue, setIdentityValue] = useState<string>(Sign_Up_Identity_Data[0]?.value);
        ...
        return (
                <View style={styles.signup_main}>
                        <CustomStatusBar barStyleLight={true} backgroundColor={Colors.Primary} backgroundDimColor={Colors.PrimaryDim} />
                        <ScrollView>
                                ...
                                <View style={styles.s_m_input_cont}>
                                        <Text style={[styles.s_m_input_text, { marginTop: 23 }]}>Register as</Text>
                                        <RNDropDown dropdownData={Sign_Up_Identity_Data} value={identityValue} setValue={setIdentityValue} />
                                        <BasicButton buttonText="Get Started" buttonHeight={52} marginTop={35} marginBottom={16} execFunc={() => on_get_started()} disabled={disableButton} />
                                </View>
                        </ScrollView>
                </View>
        );
