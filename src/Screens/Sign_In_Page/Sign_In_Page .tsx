...
const SignInPage: FunctionComponent = () => {
        ...
        return (
                <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.signin_main}>
                        ...
                        <ScrollView style={{ flex: 1 }} ref={ref => (scrollViewRef.current = ref)}>
                                ...
                                <View style={styles.s_m_input_cont}>
                                        ...
                                        <Text style={[styles.s_m_input_text, { marginTop: 26 }]}>Password</Text>
                                        <SecureTextEntry inputValue={password} setInputValue={setPassword} keyboardType="default" />
                                        <BasicButton buttonText="Login" buttonHeight={52} marginTop={23} disabled={disableButton} marginBottom={16} execFunc={() => sign_in_user()} />
                                        ...
                                        <BasicLogoButton logoName="Google" inputText="Sign In with Google" marginTop={15} disabled={disableButton} execFunc={() => sign_in_with_google()} />
