...
const InfoPage: FunctionComponent = () => {
        ...
        const proceed = () => {
                ...
                switch (route?.params?.proceed_type) {
                        case 1:
                                navigation.push('AuthStack' as never, { screen: 'SignInPage' } as never);
                                break;
                        case 2:
                                navigation.navigate('HomeStack' as never, { screen: 'HomePage' } as never);
                                break;
                        case 3:
                                setTimeout(async () => {
                                        try {
        ...
        return (
                <View style={{ flex: 1 }}>
                        ...
                        <View style={styles.info_main}>
                                <TouchableOpacity style={styles.i_m_bb} disabled={hide_back_btn} onPress={() => navigation.canGoBack() && navigation.goBack()}>
                                        {!hide_back_btn && <Feather name="chevron-left" size={35} color={'black'} />}
                                </TouchableOpacity>
                                <LottieView
                                        style={{
                                                transform: [{ scale: 1 }],
                                ...
                                <View
                                        ...
                                        <BasicButton buttonText="PROCEED" buttonHeight={52} marginTop={0} marginBottom={0} disabled={disableButton} execFunc={() => proceed()} />
                                </View>
                        </View>
                </View>
        );
