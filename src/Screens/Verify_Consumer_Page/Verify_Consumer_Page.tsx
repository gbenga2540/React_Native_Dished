                ...
                <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.vr_main}>
                        ...
                        <ScrollView style={{ flex: 1 }} ref={ref => (scrollViewRef.current = ref)}>
                                ...
                                <View style={styles.v_c_input_cont}>
                                        <Text style={[styles.v_c_input_text, { marginTop: 26 }]}>Full Name</Text>
                                        <BasicTextEntry placeHolderText="John Doe" inputValue={fullName} setInputValue={setFullName} keyboardType="default" />
                                        <Text style={[styles.v_c_input_text, { marginTop: 26 }]}>Phone Number</Text>
                                        ...
                                        <Text style={[styles.v_c_input_text, { marginTop: 26 }]}>Address</Text>
                                        <BasicTextEntry placeHolderText="No 1, Alagbaka, Akure, Ondo State." inputValue={address} setInputValue={setAddress} keyboardType="default" />
                                        <BasicButton buttonText="Verify" buttonHeight={52} marginTop={23} disabled={disableButton} marginBottom={16} execFunc={() => on_verify_profile()} />
                                </View>
                        </ScrollView>
