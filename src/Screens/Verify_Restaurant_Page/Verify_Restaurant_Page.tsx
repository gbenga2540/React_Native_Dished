...
const VerifyRestaurantPage: FunctionComponent = () => {
        ...
        const on_verify_profile = async () => {
                if (businessName?.length > 0 && phoneNo?.length > 0 && location?.length > 0) {
                ...
                <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.vr_main}>
                        ...
                        <ScrollView style={{ flex: 1 }} ref={ref => (scrollViewRef.current = ref)}>
                                ...
                                <View style={styles.v_r_input_cont}>
                                        <Text style={[styles.v_r_input_text, { marginTop: 26 }]}>Business Name</Text>
                                        <BasicTextEntry placeHolderText="Chicken Republic" inputValue={businessName} setInputValue={setBusinessName} keyboardType="default" />
                                        <Text style={[styles.v_r_input_text, { marginTop: 26 }]}>Phone Number</Text>
                                        <BasicTextEntry placeHolderText="08101234567" inputValue={phoneNo} setInputValue={setPhoneNo} keyboardType="numbers-and-punctuation" />
                                        <Text style={[styles.v_r_input_text, { marginTop: 26 }]}>Location</Text>
                                        <BasicTextEntry placeHolderText="No 1, Alagbaka, Akure, Ondo State." inputValue={location} setInputValue={setLocation} keyboardType="default" />
                                        <Text style={[styles.v_r_input_text, { marginTop: 26 }]}>Certification</Text>
                                        <TextWithButton placeHolderText="Upload CAC" inputValue={CACText} setInputValue={setCACText} execFunc={() => console.log('uploading CAC')} />
                                        <BasicButton buttonText="Verify" disabled={disableButton} buttonHeight={52} marginTop={23} marginBottom={16} execFunc={() => on_verify_profile()} />
                                </View>
                        </ScrollView>
