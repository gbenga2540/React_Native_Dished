...
import { Image, StyleSheet, View, ScrollView, Dimensions, Platform } from 'react-native';
...
const OnboardingPage: FunctionComponent = () => {
        ...
        // @ts-ignore
        const renderItem = ({ item, index }: { item: Onboarding_Props; index: number }) => {
        ...
        return (
                <View style={styles.op_main}>
                        ...
                        <View style={styles.op_m_skip}>
                                <TextButton buttonText="Skip" execFunc={() => skip_onboarding()} textColor={Colors.Secondary} disabled={disableButton} isFontLight />
                        </View>
                        <ScrollView style={{ flex: 1 }}>
                                ...
                                <BasicButton buttonText="Skip" buttonHeight={43} marginHorizontal={19} marginTop={50} borderRadius={20} disabled={disableButton} execFunc={() => skip_onboarding()} />
                                <Image source={require('../../Images/Onboarding/Woman_Chef_Art.png')} style={styles.op_m_wca} />
                                <Image source={require('../../Images/Onboarding/Cooking_Pot.png')} style={styles.op_m_cp} />
                        </ScrollView>
                </View>
        );
};
