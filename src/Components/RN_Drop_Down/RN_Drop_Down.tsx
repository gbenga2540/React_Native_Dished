...
const RNDropDown: FunctionComponent<DropDownProps> = ({ borderColor, backgroundColor, showLabel, labelTitle, dropdownData, focusPlaceHolder, unFocusPlaceHolder, value, setValue, height, marginTop, marginBottom, marginHorizontal, marginLeft, marginRight, paddingHorizontal, disable }) => {
