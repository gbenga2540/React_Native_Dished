...
const BasicLogoButton: FunctionComponent<BasicLogoButtonProps> = ({ logoName, inputText, marginTop, marginBottom, execFunc, disabled }) => {
        return (
                <TouchableOpacity disabled={disabled || false} onPress={() => execFunc()} activeOpacity={0.65} style={[styles.b_l_b_main, { marginTop: marginTop || 0, marginBottom: marginBottom || 0 }]}>
