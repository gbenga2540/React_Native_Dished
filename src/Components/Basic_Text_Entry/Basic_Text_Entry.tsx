...
import { KeyboardAvoidingView, KeyboardTypeOptions, StyleSheet, TextInput } from 'react-native';
...
const BasicTextEntry: FunctionComponent<BasicTextEntryProps> = ({ inputValue, placeHolderText, keyboardType, setInputValue, onFocus }) => {
        return (
